...
export const { addUserData, refreshUserToken, clearUserData } = userSlice.actions

// Other code such as selectors can use the imported `RootState` type
export const selectUser = (state: RootState) => state.user
export const getIsUserAuthorized = (state: RootState) => dayjs(state.user.tokenExpiryTime) > dayjs().utc()
